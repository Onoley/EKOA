...
export default async function PublicProfilePage({params}:{params:Promise<{username:string}>}){
 ...
 const[{data:questions,error},{data:verifiedRows}]=await Promise.all([supabase.rpc("get_public_profile_questions",{requested_user_id:profile.user_id}),profile.account_type==="verified"?supabase.rpc("get_verified_public_details",{requested_user_id:profile.user_id}):Promise.resolve({data:null})]);
