...
Sessions, réservations, contrôles utilisateur et composantes de score ont RLS actif sans droit direct navigateur. Les RPC de génération et réservation exigent `service_role`; l’API vérifie auparavant identité et profil actif. Le moteur n’utilise ni réponse choisie ni démographie hors contrôle d’âge, et le sponsoring ne reçoit aucun signal individuel sensible.
